...
private _itemColor = "";
private _slotColor = "";
private _slotNameArray = missionNamespace getVariable [KATQGVAR(misc,FAKSlotNames), []];
private _slotName = "";
...
switch (_fakType) do {
    case 0: { 
        _fakContent = missionNamespace getVariable [KATQGVAR(misc,IFAKContents), []];
        _slotColor = [(missionNamespace getVariable [KATQGVAR(misc,IFAK_Slot_Color), []])] call _fnc_arrayToHexCode;
        _itemColor = [(missionNamespace getVariable [KATQGVAR(misc,IFAK_Item_Color), []])] call _fnc_arrayToHexCode;
    };
    case 1: { 
        _fakContent = missionNamespace getVariable [KATQGVAR(misc,AFAKContents), []];
        _slotColor = [(missionNamespace getVariable [KATQGVAR(misc,AFAK_Slot_Color), []])] call _fnc_arrayToHexCode;
        _itemColor = [(missionNamespace getVariable [KATQGVAR(misc,AFAK_Item_Color), []])] call _fnc_arrayToHexCode;
    };
    case 3: { 
        _fakContent = missionNamespace getVariable [KATQGVAR(misc,M1Contents), []];
        _slotColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Slot_Color), []])] call _fnc_arrayToHexCode;
        _itemColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Item_Color), []])] call _fnc_arrayToHexCode;
    };
    case 4: { 
        _fakContent = missionNamespace getVariable [KATQGVAR(misc,M2Contents), []];
        _slotColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Slot_Color), []])] call _fnc_arrayToHexCode;
        _itemColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Item_Color), []])] call _fnc_arrayToHexCode;
    };
    default { 
        _fakContent = missionNamespace getVariable [KATQGVAR(misc,MFAKContents), []];
        _slotColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Slot_Color), []])] call _fnc_arrayToHexCode;
        _itemColor = [(missionNamespace getVariable [KATQGVAR(misc,MFAK_Item_Color), []])] call _fnc_arrayToHexCode;
    };
};
