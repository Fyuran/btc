...
switch (_type) do {
    case 0: {_requiredItems = missionNamespace getVariable [KATQGVAR(misc,IFAKContents), []];}; // IFAK
    case 1: {_requiredItems = missionNamespace getVariable [KATQGVAR(misc,AFAKContents), []];}; // AFAK
    case 3: {_requiredItems = missionNamespace getVariable [KATQGVAR(misc,M1Contents), []];}; // M1
    case 4: {_requiredItems = missionNamespace getVariable [KATQGVAR(misc,M2Contents), []];}; // M2
    default {_requiredItems = missionNamespace getVariable [KATQGVAR(misc,MFAKContents), []];}; // MFAK
};
